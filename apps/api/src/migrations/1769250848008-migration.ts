...
export class Migration1769250848008 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "runner" RENAME COLUMN "availabilityScore" TO "generalAvailability"`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "runner" RENAME COLUMN "generalAvailability" TO "availabilityScore"`)
  }
}
