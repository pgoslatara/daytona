...
Daytona provides methods to list files and directories in a sandbox using Python and TypeScript.
...
> [list_files (Python SDK)](/docs/python-sdk/sync/file-system/#filesystemlist_files)
> 
> [listFiles (TypeScript SDK)](/docs/typescript-sdk/file-system/#listfiles)

### Get file information

Daytona provides methods to get file information using Python and TypeScript.
...
Daytona provides methods to create directories with specific permissions using Python and TypeScript.
...
Daytona provides methods to read, write, upload, download, and delete files in sandboxes using Python and TypeScript.
...
Daytona provides advanced file system operations like file permissions, search and replace, and more.

### File permissions

Daytona provides methods to set file permissions, get file permissions, and set directory permissions recursively using Python and TypeScript.
...
Daytona provides methods to search for text in files and replace text in files using Python and TypeScript.
...
Daytona provides methods to move or replace files using Python and TypeScript.
