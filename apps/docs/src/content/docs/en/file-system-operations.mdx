...
Daytona provides methods to download a single file from sandboxes. The following snippet downloads a single file `file1.txt` from the sandbox working directory and prints the content:
...
>
> [**move or rename files (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/POST/files/move)
