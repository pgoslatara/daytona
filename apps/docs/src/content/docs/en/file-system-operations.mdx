...
Daytona provides methods to list files and directories in a sandbox using Python and TypeScript. The following snippet shows how to list files in a directory by providing the path to the directory.
...
Daytona provides methods to get file information using Python and TypeScript. The following snippet shows how to get file information by providing the path to the file.
...
Daytona provides methods to create directories with specific permissions using Python and TypeScript. The following snippet shows how to create a directory by providing the path to the directory and the permissions to set.
...
Daytona provides methods to upload files in sandboxes using Python and TypeScript.

#### Upload a single file

Daytona provides methods to upload a single file in sandboxes using Python and TypeScript. The following snippet shows how to upload a single file by providing the content to upload and the path to the file to upload it to.
...
Daytona provides methods to upload multiple files in sandboxes using Python and TypeScript. The following snippet shows how to efficiently upload multiple files with a single method call by providing the paths to the files and the content to upload.
...
Daytona provides methods to download files from sandboxes using Python and TypeScript.

#### Download a single file

Daytona provides methods to download a single file from sandboxes using Python and TypeScript. The following snippet downloads a single file `file1.txt` from the sandbox working directory and prints out the content:
...
Daytona provides methods to download multiple files from sandboxes using Python and TypeScript. The following snippet shows how to efficiently download multiple files with a single method call.
...
Daytona provides methods to delete files from sandboxes using Python and TypeScript. The following snippet shows how to delete a file by providing the path to the file.
...
Daytona provides methods to set file permissions, get file permissions, and set directory permissions recursively using Python and TypeScript. The following snippet shows how to set file permissions by providing the path to the file and the permissions to set.
...
Daytona provides methods to search for text in files and replace text in files using Python and TypeScript. The following snippet shows how to search for text in files and replace text in files by providing the path to the files and the text to search for and the text to replace it with.
...
Daytona provides methods to move or replace files using Python and TypeScript. The following snippet shows how to move a file to a new location by providing the path to the file and the new path.
