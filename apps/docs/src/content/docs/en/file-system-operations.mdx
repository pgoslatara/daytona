...
Daytona provides methods to list files and directories in a sandbox. The following snippet shows how to list files in a directory by providing the path to the directory.
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/) and [API](/docs/en/tools/api/#daytona-toolbox) references:
...
>
> [**list directories and files (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/GET/files)

### Get file information

Daytona provides methods to get file information. The following snippet shows how to get file information by providing the path to the file.
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/) and [API](/docs/en/tools/api/) references:
...
Daytona provides methods to create directories with specific permissions. The following snippet shows how to create a directory by providing the path to the directory and the permissions to set.
...
>
> [**create directory (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/POST/files/folder)

### Upload files

Daytona provides methods to upload files in sandboxes.

#### Upload a single file

Daytona provides methods to upload a single file in sandboxes. The following snippet shows how to upload a single file by providing the content to upload and the path to the file to upload it to.
...
Daytona provides methods to upload multiple files in sandboxes. The following snippet shows how to efficiently upload multiple files with a single method call by providing the paths to the files and the content to upload.
...
>
> [**upload files (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/POST/files/bulk-upload)
...
Daytona provides methods to download a single file from sandboxes. The following snippet downloads a single file `file1.txt` from the sandbox working directory and prints out the content:
...
Daytona provides methods to download multiple files from sandboxes. The following snippet shows how to efficiently download multiple files with a single method call.
...
>
> [**download files (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/POST/files/bulk-download)

### Delete files

Daytona provides methods to delete files from sandboxes. The following snippet shows how to delete a file by providing the path to the file.
...
>
> [**delete file (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/DELETE/files)

## Advanced operations

Daytona provides advanced file system operations like [file permissions](#file-permissions), [search and replace](#file-search-and-replace), and more.

### File permissions

Daytona provides methods to set file permissions, get file permissions, and set directory permissions recursively. The following snippet shows how to set file permissions by providing the path to the file and the permissions to set.
...
Daytona provides methods to search for text in files and replace text in files. The following snippet shows how to search for text in files and replace text in files by providing the path to the files and the text to search for and the text to replace it with.
...
Daytona provides methods to move or replace files. The following snippet shows how to move a file to a new location by providing the path to the file and the new path.
...
> [**move_file (Python SDK)**](/docs/en/python-sdk/sync/file-system/#filesystemmove_files)
> 
> [**moveFile (TypeScript SDK)**](/docs/en/typescript-sdk/file-system/#movefiles)
>
> [**move or rename file (API)**](/docs/en/tools/api/#daytona-toolbox/tag/file-system/POST/files/move)
