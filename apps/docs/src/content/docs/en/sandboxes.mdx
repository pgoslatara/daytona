...
>
> [**create (CLI)**](/docs/en/tools/cli/#daytona-sandbox-create)
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/daytona#resources) and [TypeScript SDK](/docs/en/typescript-sdk/daytona#resources) references:
...
Daytona provides options to start sandboxes using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/) or programmatically using the [Python SDK](/docs/en/python-sdk/) and [TypeScript SDK](/docs/en/typescript-sdk/).
...
<TabItem label="CLI" icon="seti:shell">
```bash
daytona sandbox start [flags]
```
</TabItem>
</Tabs>

For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxstop) and [TypeScript SDK](/docs/typescript-sdk/sandbox#stop) references:
...
>
> [**start (CLI)**](/docs/en/tools/cli/#daytona-sandbox-start)
...
>
> [**list (CLI)**](/docs/en/tools/cli/#daytona-sandbox-list)
...
> [**stop (Python SDK)**](/docs/python-sdk/sync/sandbox#sandboxstop)
>
>[**stop (TypeScript SDK)**](/docs/typescript-sdk/sandbox#stop)
>
> [**find_one (Python SDK)**](/docs/python-sdk/sync/daytona#daytonafind_one)
>
> [**findOne (TypeScript SDK)**](/docs/typescript-sdk/daytona#findone)
>
> [**stop (API)**](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/stop)
>
> [**stop (CLI)**](/docs/en/tools/cli/#daytona-sandbox-stop)
...
>
> [**archive (CLI)**](/docs/en/tools/cli/#daytona-sandbox-archive)
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxrecover) and [TypeScript SDK](/docs/typescript-sdk/sandbox#recover) references:
...
>
> [**delete (CLI)**](/docs/en/tools/cli/#daytona-sandbox-delete)
...
<TabItem label="API" icon="seti:json">
```bash
curl 'https://app.daytona.io/api/sandbox/{sandboxIdOrName}/autostop/1' \
  --request POST \
  --header 'Authorization: Bearer YOUR_SECRET_TOKEN'
```
</TabItem>
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_autostop_interval) and [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_stop_interval) references:
...
<TabItem label="API" icon="seti:json">
```bash
curl 'https://app.daytona.io/api/sandbox/{sandboxIdOrName}/autoarchive/1' \
  --request POST \
  --header 'Authorization: Bearer YOUR_SECRET_TOKEN'
```
</TabItem>
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_auto_archive_interval) and [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_archive_interval) references:
...
<TabItem label="API" icon="seti:json">
```bash
curl 'https://app.daytona.io/api/sandbox/{sandboxIdOrName}/autodelete/1' \
  --request POST \
  --header 'Authorization: Bearer YOUR_SECRET_TOKEN'
```
</TabItem>
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_auto_delete_interval) and [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_delete_interval) references:
